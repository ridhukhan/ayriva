...
export default function ProductDetailPage({ params }) {
  ...
  const { data, error, isLoading } = useSWR(
    ...
    fetcher,
    {
      ...
      dedupingInterval: 600000, // ১০ মিনিট মেমোরি ক্যাশিং
    }
  );
          ...
          <div className="flex gap-3 mb-6 overflow-x-auto pb-2">
            {allImages.map((imgUrl, index) => (
              <button
                ...
                className={`w-16 h-16 md:w-20 md:h-20 rounded-lg overflow-hidden border-2 transition shrink-0 cursor-pointer ${
        ...
        <div className="border border-amber-200 rounded-2xl p-4 md:p-6 bg-amber-50/50 mt-4">
          ...
          <form onSubmit={handleOrderSubmit} className="flex flex-col gap-3">
            ...
            <input
              ...
              className="p-3 border border-gray-[#00000020] rounded-xl text-black font-medium text-sm bg-white"
              required
            />
